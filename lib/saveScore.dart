...
import './HomeScreen.dart';
  ...
  Future<void> saveHighScore(int score,int? time) async {
    var box = await Hive.openBox('highScores');
    var mintime = await Hive.openBox('fastestTimeMs');
    box.put('highScore', score); // Save high score locally
    mintime.put('fastestTimeMs', time); // Save high score locally
  }
...
// }
  ...
  Future<void> submitHighScore({required int score, int? timeMs,}) async {
    ...
    await saveHighScore(score,timeMs);
